...
public class ProSurplus extends JPanel
{
  ...
  public void paintComponent (Graphics g)
  {
    ...
    Image conSurplus = Toolkit.getDefaultToolkit ().getImage ("Backgrounds/ProSurplus" + counter + ".png");
    ...
    if (counter == 1)
    {
      g.drawString ("Equation", 518, 307); //output the equation of the supply curve onto the screen
    }
    else if (counter == 2)
    {
    ...
    {
      g.drawString ("Equation", 260, 350); //output the equation of the supply curve
